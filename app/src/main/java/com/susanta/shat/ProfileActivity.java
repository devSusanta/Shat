...
public class ProfileActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		checkbox1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton _param1, boolean _param2) {
				...
				if (_isChecked) {
					bool.edit().putString("autodown", "on").commit();
				}
				else {
					bool.edit().putString("autodown", "off").commit();
				}
			}
		});
		...
		name.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (ename.getVisibility() == View.GONE) {
					name.setText("Save");
					ename.setVisibility(View.VISIBLE);
					ename.setText(userdblocal.getString("name", ""));
				}
				else {
					if (!ename.getText().toString().equals("")) {
						...
						usermap.clear();
						userdblocal.edit().putString("name", ename.getText().toString()).commit();
						name.setText(ename.getText().toString());
						ename.setVisibility(View.GONE);
					}
					else {
						((EditText)ename).setError("Please Enter Name");
					}
				}
			}
		});
	...
	private void initializeLogic() {
		...
		name.setText(userdblocal.getString("name", ""));
